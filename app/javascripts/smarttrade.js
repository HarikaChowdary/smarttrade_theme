...
stsContract.getAuction.call(aucid).then(function(result) {
...
console.log("entered.");
    ...
    if (typeof stsContract != 'undefined' && typeof account != 'undefined') {
        web3.eth.getBalance(stsContract.address, function(err, bal) {
            console.log("contract balance: " + bal);
        });
        

        stsContract.getRefundValue.call({from:account}).then(function(refundBalance) {
...
function withdraw() {
    if (typeof stsContract != 'undefined' && typeof account != 'undefined') {
        ...
        stsContract.withdrawRefund({from:account, gas:500000}).then(function(txId) {
